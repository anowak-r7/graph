...
import com.rapid7.diskstorage.dynamodb.iterator.ParallelScanner;
import com.rapid7.diskstorage.dynamodb.iterator.ScanSegmentWorker;
    ...
    public Future<ScanResult> scanAsync(final ScanRequest request, final int permitsToConsume) {
        return clientThreadPool.submit(new Callable<ScanResult>() {
            ...
            public ScanResult call() throws Exception {
                final ExponentialBackoff.Scan backoff = new ExponentialBackoff.Scan(request, DynamoDBDelegate.this, permitsToConsume);
